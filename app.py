...
st.set_page_config(page_title='No Code, Regressor',
    layout='wide')
#---------------------------------#
# Model building
def build_model(df):
...
Leveraging the **lazypredict** library to help you build and compare 40 regression algorithms on your own dataset without knowing how to code!

Developed by: [Debadri Sengupta](https://www.linkedin.com/in/debadri-sengupta-61665a14b/)
